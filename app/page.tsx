  ...
  return (
    <main className="overflow-hidden">
      <div className="relative">
        <Image
          src="http://web-imaray.local/wp-content/uploads/2026/01/slider-principal.png"
        ...
        <div className="">
          ...
          />
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/hamburger-menu.png"
            alt="Logo header"
            width={40}
            height={40}
        ...
        <div className={`bg-white absolute w-full h-[70vh] md:h-[85vh] top-0 right-0 md:w-80 pt-12 pl-12 menu transition-transform duration-400 z-10 ${activeMenu ? 'translate-x-0' : 'translate-x-400'}`} >
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/logo-imaray-black.png"
            alt="Logo header"
            width={150}
            height={150}
            className=""
          />
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/cross-ico.png"
            alt="Close icono"
            width={20}
            height={20}
        ...
        <div className="absolute bottom-5 left-20">
          <div className="flex gap-4">
            <Image
              src="http://web-imaray.local/wp-content/uploads/2026/01/ig-ico-transparent.png"
            ...
            />
            <Image
              src="http://web-imaray.local/wp-content/uploads/2026/01/fb-ico-transparent.png"
              alt="Instagram transparente"
              width={40}
              height={40}
              className=""
            />
            <Image
              src="http://web-imaray.local/wp-content/uploads/2026/01/yt-ico-transparent.png"
              alt="Instagram transparente"
              width={40}
              height={40}
              className=""
            />
            <Image
              src="http://web-imaray.local/wp-content/uploads/2026/01/tiktok-ico-transparent.png"
              alt="Instagram transparente"
              width={40}
              height={40}
              className=""
      ...
      <div className=" bg-black py-16">
        <div className="max-w-5xl mx-auto flex flex-col gap-8 md:gap-0 md:flex-row justify-center items-center relative md:px-0 px-8">
          ...
          <div>
            <Image
              src="http://web-imaray.local/wp-content/uploads/2026/01/Sold-out.png"
              alt="Imaray Ulloa"
              width={400}
              height={300}
          ...
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/heart-right.png"
          ...
          />
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/heart-left.png"
      ...
      <div
        ...
        style={{ backgroundImage: "url('http://web-imaray.local/wp-content/uploads/2026/01/fondo-yt.png')" }}>
        <div className="max-w-5xl mx-auto relative md:h-[70vh] 2xl:h-[55vh] pt-18">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-14 md:gap-18 md:h-[45vh] 2xl:h-[40vh] py-10 md:py-0">
            <div className="flex flex-col items-center ">
              <Image
                src="http://web-imaray.local/wp-content/uploads/2026/01/yt.png"
                alt="Youtube Icono"
                width={100}
                height={100}
          ...
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/yt-channel.png"
          ...
          />
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/yt-podcast.png"
      ...
      <div className="bg-white font-sans overflow-hidden">
        <div className="md:max-w-5xl mx-auto relative ">
          ...
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/evento-miami-scaled.png"
            alt="Youtube Podcast Imaray"
            width={450}
            height={450}
      ...
      <div className="md:h-[90vh] 2xl:h-[60vh] bg-center bg-cover relative overflow-hidden" style={{ backgroundImage: "url('http://web-imaray.local/wp-content/uploads/2026/01/fondo-contacto-imaray.png')" }}>
          <Image
            src="http://web-imaray.local/wp-content/uploads/2026/01/imaray-contacto.png"
